...
Each customer or shipbroker can only validate (exactly) one address. \\ \\
...
Our ER-model is visualized on the following page.
\newgeometry{margin=1cm}
\begin{landscape}
\begin{figure}
	\centering
		\includegraphics[width=1.40\textwidth]{C:/Users/Zimcke/Documents/GitHub/gegevensbanken/databases_part1/er_diagram.jpg}
	\label{fig:opdracht1}
\end{figure}
\end{landscape}
\restoregeometry
