...
The tax per port is not multivalue, there is only one taxrate per port (independent from the ship type or other characteristics).\\
We assume that a ship can't have more than one route simultaneously. 

\section{ER-diagram}


Still have to put image here.
